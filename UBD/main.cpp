...
char string2[]="Pick up Kalculus";
void *font2=GLUT_BITMAP_TIMES_ROMAN_24;
int k;
glColor3f(1.0,1.0,1.0);
glRasterPos3f(830-600+20,100+150,70);
for(k=0;k<strlen(string2);k++)
        glutBitmapCharacter(font2,string2[k]);
...
glColor3f(1.0,1.0,1.0);
glRasterPos3f(830-600+20,80+150,70);
...
char string2[]="YAY! Now get Kalculus";
void *font2=GLUT_BITMAP_TIMES_ROMAN_24;
int k;
glColor3ub(240,0,0);
glRasterPos3f(832-600+20,100+150,70);
for(k=0;k<strlen(string2);k++)
        glutBitmapCharacter(font2,string2[k]);

char string3[]="to SRID Campus";
void *font3=GLUT_BITMAP_TIMES_ROMAN_24;
glColor3ub(240,0,0);
glRasterPos3f(832-600+20,100+130,70);
for(k=0;k<strlen(string3);k++)
        glutBitmapCharacter(font3,string3[k]);


 char string5[]="just straight ahead.";
void *font5=GLUT_BITMAP_TIMES_ROMAN_24;
glColor3ub(240,0,0);
glRasterPos3f(834-600+20,100+110,70);
for(k=0;k<strlen(string5);k++)
        glutBitmapCharacter(font5,string5[k]);
...
void outputTitle(int x, int y, char *string)
{
    void *font=GLUT_BITMAP_TIMES_ROMAN_24;
      int len, i;
...
void outputNorm(int x, int y, char *string)
{
